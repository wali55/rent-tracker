      ...
      >
        ...
        <div className="flex flex-col gap-2">
          <div className="w-full flex flex-col gap-2">
            ...
            <input type="text" id="name" name="name" value={formData.name} onChange={handleChange}  className="border rounded-md p-2" />
          </div>
          <div className="w-full flex flex-col gap-2">
            <label htmlFor="apartment">এপার্টমেন্ট</label>
            <input type="text" id="apartment" name="apartment" value={formData.apartment} onChange={handleChange} className="border rounded-md p-2" />
          </div>
          <div className="w-full flex flex-col gap-2">
            <label htmlFor="mobile">মোবাইল</label>
            <input type="text" id="mobile" name="mobile" value={formData.mobile} onChange={handleChange} className="border rounded-md p-2" />
          </div>
          <div className="w-full flex flex-col gap-2">
            <label htmlFor="baseRent">বেসিক ভাড়া (টাকা)</label>
            <input type="text" id="baseRent" name="baseRent" value={formData.baseRent} onChange={handleChange} className="border rounded-md p-2" />
          </div>
        </div>
