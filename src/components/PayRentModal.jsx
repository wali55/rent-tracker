    ...
    <div>
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="w-full flex flex-col gap-2">
              <label htmlFor="name">পেমেন্টের তারিখ</label>
              <input type="text" id="name" className="border rounded-md" />
            </div>
            <div className="w-full flex flex-col gap-2">
              <label htmlFor="name">বকেয়া ভাড়া (টাকা)</label>
              <input type="text" id="name" className="border rounded-md" />
            </div>
            <div className="w-full flex flex-col gap-2">
              <label htmlFor="name">পেমেন্ট (টাকা)</label>
              <input type="text" id="name" className="border rounded-md" />
            </div>
            <div className="w-full flex flex-col gap-2">
              <label htmlFor="name">অবশিষ্ট (টাকা)</label>
              <input type="text" id="name" className="border rounded-md" />
            </div>
          </div>
